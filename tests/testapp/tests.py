...
class ListTest(TestCase):
    ...
    @patch('admin_cli.settings.ALLOWED_USERS', {os.getlogin(): 'W'})
...
class DeleteTest(TestCase):
    ...
    @patch('admin_cli.settings.ALLOWED_USERS', {os.getlogin(): 'R'})
    def test_no_access(self, *args):
        with self.assertRaises(CommandError):
...
class UserHasAccessTest(TestCase):
    ...
    @patch('admin_cli.settings.ALLOWED_USERS', {})
    def test_default_access(self, *args):
        self.command._user_has_access('R')
        self.command._user_has_access('W')
    ...
    @patch('admin_cli.settings.ALLOWED_USERS', {os.getuid(): 'R'})
    def test_uid_read_access(self, *args):
        self.command._user_has_access('R')

    @patch('admin_cli.settings.ALLOWED_USERS', {os.getuid(): 'W'})
    def test_uid_no_read_access(self, *args):
        with self.assertRaises(CommandError):
            self.command._user_has_access('R')

    @patch('admin_cli.settings.ALLOWED_USERS', {'FOOUSER': 'R'})
